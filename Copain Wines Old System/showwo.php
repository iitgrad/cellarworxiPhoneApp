...
<?php
...

  {
   ...
   function showallwobystatus($status,$assignedto)
...
function displaywobystatus($status,$showstates,$assignedto="")

{

  echo '<table id=table1 align="center" width="100%">';

  echo '<tr><td colspan="7" align="center">ALL '.$status.' WORK ORDERS</td></tr>';

  $pwo=showallwobystatus($status,$assignedto);

   echo '<tr valign=bottom>';

   echo '<td align="center" >WO ID<hr></td>';

   echo '<td align="center" >DUE DATE<hr></td>';

   echo '<td align="center" >CLIENT<BR>CODE<hr></td>';

   echo '<td align="center" >LOT<hr></td>';

   echo '<td align="center" >ACTIVITY<hr></td>';

   echo '<td align="center" width=30%>COMMENTS<hr></td>';

   echo '<td align="center" >ASSIGNED<hr></td>';

   echo '<td align="center" >ACTION<hr></td>';
...

  {
    ...
    echo '<tr>'.
     ...
     '<td align="center">'.strtoupper($pwo[$i]['CLIENTCODE']).'</td>'.
...
tigra_tables('table1', 2, 0, '#ffffff', 'PapayaWhip', 'LightSkyBlue', '#cccccc');
...
<?php
  ...
  displaywobystatus($_GET['status'],$showstates,$_GET['assignedto']);
